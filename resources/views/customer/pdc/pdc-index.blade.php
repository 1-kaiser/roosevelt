        ...
        <div class="max-w-full mx-auto px-32">
            ...
            <form class="w-full" action="{{ route('pdc-save') }}" id="pdcForm" method="POST" enctype="multipart/form-data">
                ...
                <div class="flex flex-wrap -mx-3 mb-6">
                    ...
                    <input class="appearance-none block w-full bg-gray-200 text-gray-70 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" id="grid-first-name" value="{{ old('age') }}" id="age" name="age" type="number" placeholder="20">
                    ...
                    <select name="transmission" class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" value="{{ old('date') }}" id="date">
                        <option value="---">---</option>
                    ...
                    {{-- Transmission --}}
                    <x-input type="hidden" value="PDC" id="course" name="course"/>
                </div>
                <div class="flex flex-wrap -mx-3 mb-6">
